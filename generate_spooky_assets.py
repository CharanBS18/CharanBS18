...
<p align="center" style="font-family: monospace; color: #f8f9fa; font-size: 14px;">
  ...
  <br><br>
  <a href="mailto:{email}" style="display: inline-block; background-color: #240046; color: #ff7518; border: 2px solid #ff7518; padding: 12px 24px; border-radius: 6px; text-decoration: none; font-weight: bold; font-family: monospace;">
    📧 SEND RAVEN SUMMONS
  </a>
</p>
